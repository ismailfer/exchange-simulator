...
import com.ismail.exchsim.model.ApiException;
import com.ismail.exchsim.web.PageInfo;
...
public class WebUtil
{
    ...
    public static int geti(UpgradeRequest request, String pParamName)
    {
        String str = get(request, pParamName);
     ...
     * @return
     */
    public static int geti(UpgradeRequest request, String pParamName, int pDefaultValue)
    {
        String str = get(request, pParamName, null);
